...
int main()
{
    ...
    K[0] = 1.0;
    Gamma[0] = 2.0;
    rhoBound[0] = 0.145999611225; //Central Density
    ...
    const int size = 1000000; // How many steps are we going to take? 
    ...
    double absolute_error_limit = 1e-16; // How big do we let the absolute error be?
    double relative_error_limit = 1e-16; // How big do we let the relative error be?
